...
class Entity(arcade.Sprite):
    def __init__(self, name_folder, name_file):
        ...
        self.idle_texture_pair = load_texture_pair(f"{main_path}idle/tile007.png")
        self.jump_texture_pair = load_texture_pair(f"{main_path}jump/tile012.png")

        # Load textures for running
        self.walk_textures = []
        for i in range(3):
            texture = load_texture_pair(f"{main_path}run/tile{i}.png")
...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        self.start = arcade.load_sound("sounds/here_we_go.wav")
        self.yahoo = arcade.load_sound("sounds/yahoo.wav")
        self.waha = arcade.load_sound("sounds/waha.wav")
    ...
    def on_key_press(self, key, modifiers):
        ...
        if key == arcade.key.UP or key == arcade.key.W:
            ...
            if a > 90:
                arcade.play_sound(self.yahoo)
            if a < 10:
                arcade.play_sound(self.waha)
